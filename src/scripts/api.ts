import type { ApiResponse, CycleTransferData, MetricPeriod, MetricType, NezhaMonitor, NezhaSetting, ServerGroup, ServerMetricsData, ServiceData } from "./types";
...
export const fetchSetting = () => request<ApiResponse<NezhaSetting>>("/api/v1/setting");
